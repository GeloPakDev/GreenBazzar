...
<head>
    ...
    <link href="${pageContext.request.contextPath}/style/selected-category-style.css" rel="stylesheet">
            ...
            <span class="header-class-actions">
                <span class="search-section" style="position: absolute;right: 450px;">
                     <form class="search" action="${pageContext.request.contextPath}/controller" method="post">
                       ...
                       <button type="submit"
                               style="color :black;background-color: white;border-width: 0;position: absolute;padding-top: 12px;padding-left: 10px;">
...
<div class="selected-category"><fmt:message key="customer.selectedcategory"/> : ${category}</div>
<div class="row">
